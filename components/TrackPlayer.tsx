  ...
  return (
    <div className="flex flex-wrap items-end gap-2 border-t border-line pt-3">
      <div>
        ...
        <input className="input w-48" value={tag} onChange={(e) => setTag(e.target.value)} placeholder="#ABC123" />
      </div>
      <button className="btn" disabled={pending || !tag.trim()} onClick={() => exec(() => trackPlayer(tag), (r) => r.ok && setTag(""))}>
